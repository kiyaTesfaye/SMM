    ...
    public partial class product : Form
    {
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    con.Open();
                    string query = "delete from product where proid=" + prodid.Text + "";
                    SqlCommand cmd = new SqlCommand(query, con);
                    cmd.ExecuteNonQuery();
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    con.Open();
                    string query = "update productTbl set prodName='" + prodName.Text + "',prodQyt='" + prodQty.Text + "' , prodPrice='" + prodPrice.Text + "', prodCat='" + CatCb.SelectedValue.ToString() + "' ,where prodid=" + prodid.Text + ";";
                    SqlCommand cmd = new SqlCommand(query, con);
                    cmd.ExecuteNonQuery();
